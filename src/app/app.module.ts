...
export function myTransitionAnimation(AnimationC, navEl, opts) {
  ...
  if (enteringToolBarEle) {
    ...
    enteringToolBarItems.addElement(
      enteringToolBarEle.querySelectorAll("ion-buttons,[menuToggle]")
    );
    const enteringToolBarBg = new AnimationC();
    enteringToolBarBg.addElement(
      shadow(enteringToolBarEle).querySelector(".toolbar-background")
    );
  ...
  if (leavingEl) {
    ...
    const leavingToolBarEle = leavingEl.querySelector(
      ":scope > ion-header > ion-toolbar"
    );
    if (leavingToolBarEle) {
      ...
      leavingToolBarItems.addElement(
        leavingToolBarEle.querySelectorAll("ion-buttons,[menuToggle]")
      );
      const leavingToolBarBg = new AnimationC();
      leavingToolBarBg.addElement(
        shadow(leavingToolBarEle).querySelector(".toolbar-background")
      );
